#include "shell.h"
/**
 * cmd_cd - function that handles the cd command
...
/**
 * cmd_env - function prints env variable
 * @args : command passed by the user
 * Return: print the enviroment variable
 */

int cmd_env(__attribute__((unused)) char **args)
{
        int i;
        int len;
...
int cmd_history(__attribute__((unused)) char **args)
{

#include "shell.h"
/**
 * _cd - function that handles the cd command
...
/**
 * _help - function that prints the help for a command
 * @args: the user input
 ...
 * Return: exit command
 */
int _exit(__attribute__((unused)) char **args)
{
        exit(98);
}

/**
 * _history - displays command history
 * @args : command passed by the user
 * Return: 1
 */
int  _history(__attribute__((unused)) char **args)
{
        read_textfile("history", 99999);
        return (1);
}
